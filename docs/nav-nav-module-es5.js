...
var CardPage = /** @class */ (function () {
    function CardPage(state, sanitizer) {
        ...
        this.index = 0;
        this.flipped = false;
        var randomizedData = this.shuffle(_data__WEBPACK_IMPORTED_MODULE_4__["data"]);
        ...
        state.subject.subscribe(function (f) {
            if (f === "next") {
                _this.index = _this.index + 1 >= _data__WEBPACK_IMPORTED_MODULE_4__["data"].length ? 0 : _this.index + 1;
            }
            else if (f === "previous") {
                _this.index = _this.index - 1 < 0 ? _data__WEBPACK_IMPORTED_MODULE_4__["data"].length - 1 : _this.index - 1;
            }
            _this.flipped = false;
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _cards_card_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../cards/card.page */ "./src/app/cards/card.page.ts");
...
var routes = [
    ...
    // },
    {
        path: '',
        pathMatch: 'full',
        component: _cards_card_page__WEBPACK_IMPORTED_MODULE_3__["CardPage"]
    }
];
...
/* harmony import */ var _cards_card_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../cards/card.module */ "./src/app/cards/card.module.ts");
    ...
    TabsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            imports: [
                ...
                _cards_card_module__WEBPACK_IMPORTED_MODULE_7__["Tab2PageModule"]
            ],
