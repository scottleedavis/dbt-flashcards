...
module.exports = "<ion-header translucent>\n    <ion-toolbar>\n      <ion-title>Search</ion-title>\n      <ion-buttons slot=\"primary\">\n        <ion-button color=\"primary\" (click)=\"close()\">\n          <ion-icon slot=\"end\" name=\"close\"></ion-icon>\n        </ion-button>\n      </ion-buttons>\n    </ion-toolbar>\n    <ion-toolbar>\n      <ion-searchbar (ionChange)=\"filter($event)\"></ion-searchbar>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content fullscreen>\n    <ion-list>\n      <ion-item *ngFor=\"let card of filteredCards\"><ion-button (click)=\"select(card)\" fill=\"clear\" >{{ card.category }}: {{ card.a }}</ion-button></ion-item>\n    </ion-list>\n  </ion-content>"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _cards_card_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../cards/card.data */ "./src/app/cards/card.data.ts");
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(state) {
        this.state = state;
        this.test = true;
        this.cards = _cards_card_data__WEBPACK_IMPORTED_MODULE_2__["data"];
        this.filteredCards = this.cards;
    }
    SearchComponent.prototype.ngOnInit = function () { };
    SearchComponent.prototype.filter = function (event) {
        var pattern = event.detail.value;
        this.filteredCards = this.cards.filter(function (f) {
    ...
    SearchComponent.prototype.select = function (card) {
...
module.exports = __webpack_require__(/*! /Users/scottd/workspace/dbtmindset/flashcards/src/main.ts */"./src/main.ts");
